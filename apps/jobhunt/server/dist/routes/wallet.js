...
// GET /api/wallet
router.get("/", (_req, res) => {
    const wallet = db_1.default.prepare("SELECT * FROM wallet WHERE id = 1").get();
...
router.post("/rung", (req, res) => {
    ...
    db_1.default.prepare("UPDATE wallet SET balance = ? WHERE id = 1").run(newBalance);
